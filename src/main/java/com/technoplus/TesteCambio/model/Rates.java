...
public class Rates implements Serializable{
	...
	public String toString() {
		return "Rates [USD=" + USD + ", AED=" + AED + ", AFN=" + AFN + ", ALL=" + ALL + ", AMD=" + AMD + ", ANG=" + ANG
				+ ", AOA=" + AOA + ", ARS=" + ARS + ", AUD=" + AUD + ", AWG=" + AWG + ", AZN=" + AZN + ", BAM=" + BAM
				+ ", BBD=" + BBD + ", BDT=" + BDT + ", BGN=" + BGN + ", BHD=" + BHD + ", BIF=" + BIF + ", BMD=" + BMD
				+ ", BND=" + BND + ", BOB=" + BOB + ", BRL=" + BRL + ", BSD=" + BSD + ", BTN=" + BTN + ", BWP=" + BWP
				...
				+ ", ETB=" + ETB + ", EUR=" + EUR + ", FJD=" + FJD + ", FKP=" + FKP + ", FOK=" + FOK + ", GBP=" + GBP
				...
				+ ", IRR=" + IRR + ", ISK=" + ISK + ", JEP=" + JEP + ", JMD=" + JMD + ", JOD=" + JOD + ", JPY=" + JPY
				+ ", KES=" + KES + ", KGS=" + KGS + ", KHR=" + KHR + ", KID=" + KID + ", KMF=" + KMF + ", KRW=" + KRW
				...
				+ ", SHP=" + SHP + ", SLE=" + SLE + ", SLL=" + SLL + ", SOS=" + SOS + ", SRD=" + SRD + ", SSP=" + SSP
				+ ", STN=" + STN + ", SYP=" + SYP + ", SZL=" + SZL + ", THB=" + THB + ", TJS=" + TJS + ", TMT=" + TMT
				+ ", TND=" + TND + ", TOP=" + TOP + ", TRY=" + TRY + ", TTD=" + TTD + ", TVD=" + TVD + ", TWD=" + TWD
				+ ", TZS=" + TZS + ", UAH=" + UAH + ", UGX=" + UGX + ", UYU=" + UYU + ", UZS=" + UZS + ", VES=" + VES
				+ ", VND=" + VND + ", VUV=" + VUV + ", WST=" + WST + ", XAF=" + XAF + ", XCD=" + XCD + ", XDR=" + XDR
